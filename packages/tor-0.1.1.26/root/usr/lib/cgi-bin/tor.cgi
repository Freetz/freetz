...
<p>$(lang de:"IP Adresse" en:"IP Address"):&nbsp;<input id="address" type="text" size="16" maxlength="16" name="socks_address" value="$(httpd -e "$TOR_SOCKS_ADDRESS")">   
$(lang de:"Port" en:"Port"):&nbsp;<input id="port" type="text" size="5" maxlength="5" name="socks_port" value="$(httpd -e "$TOR_SOCKS_PORT")"></p>
<h2>$(lang de:"Fernsteuerung" en:"Remote Control") (optional)</h2>
<p>Control Port:&nbsp;<input id="control" type="text" size="5" maxlength="5" name="control_port" value="$(httpd -e "$TOR_CONTROL_PORT")"></p>
<p>$(lang de:"Zeitlimit f&uuml;r Tor-Verbindungen" en:"Circuit Idle Timeout") (optional):&nbsp;<input id="idle_timeout" type="text" size="5" maxlength="5" name="circuit_idle_timeout" value="$(httpd -e "$TOR_CIRCUIT_IDLE_TIMEOUT")"></p>
EOF
...
<p><textarea id="accept" name="socks_policy_accept" rows="4" cols="50" maxlength="255">$(httpd -e "$TOR_SOCKS_POLICY_ACCEPT")</textarea><br />
Syntax: &lt;addr&gt;[/&lt;mask&gt;]<br />
...
<p><textarea id="accept" name="entry_nodes" rows="4" cols="50" maxlength="255">$(httpd -e "$TOR_ENTRY_NODES")</textarea></p>
...
<h2>$(lang de:"Liste mit Tor Servern (einer pro Zeile)" en:"List of Tor servers (one per line)")</h2>
<p><textarea id="accept" name="exit_nodes" rows="4" cols="50" maxlength="255">$(httpd -e "$TOR_EXIT_NODES")</textarea></p>
