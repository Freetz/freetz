...
SQUASHFS3_HOST_TOOLS_lzma:=$(SQUASHFS3_HOST_TOOLS:%=%-lzma)
SQUASHFS3_HOST_TOOLS_BUILD_DIR:=$(addprefix $(SQUASHFS3_HOST_BUILD_DIR)/,$(SQUASHFS3_HOST_TOOLS) $(SQUASHFS3_HOST_TOOLS_lzma))
SQUASHFS3_HOST_TOOLS_TARGET_DIR:=$(SQUASHFS3_HOST_TOOLS:%=$(TOOLS_DIR)/%3) $(SQUASHFS3_HOST_TOOLS_lzma:%-lzma=$(TOOLS_DIR)/%3-lzma)
...
$(SQUASHFS3_HOST_TOOLS_BUILD_DIR): $(SQUASHFS3_HOST_DIR)/.unpacked $(LZMA1_HOST_DIR)/liblzma.a
	$(MAKE) CC="$(TOOLS_CC)" CXX="$(TOOLS_CXX)" LZMA_DIR="$(abspath $(LZMA1_HOST_DIR))" \
		-C $(SQUASHFS3_HOST_BUILD_DIR) \
		$(SQUASHFS3_HOST_TOOLS) $(SQUASHFS3_HOST_TOOLS_lzma)
	touch -c $@

$(SQUASHFS3_HOST_TOOLS:%=$(TOOLS_DIR)/%3): $(TOOLS_DIR)/%3: $(SQUASHFS3_HOST_BUILD_DIR)/%
	$(INSTALL_FILE)
	strip $@

$(SQUASHFS3_HOST_TOOLS_lzma:%-lzma=$(TOOLS_DIR)/%3-lzma): $(TOOLS_DIR)/%3-lzma: $(SQUASHFS3_HOST_BUILD_DIR)/%-lzma
	$(INSTALL_FILE)
	strip $@
