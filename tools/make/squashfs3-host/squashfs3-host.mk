...
SQUASHFS3_HOST_TOOLS:=mksquashfs3 unsquashfs3 mksquashfs3-lzma unsquashfs3-lzma
SQUASHFS3_HOST_TOOLS_BUILD_DIR:=$(addprefix $(SQUASHFS3_HOST_BUILD_DIR)/,$(SQUASHFS3_HOST_TOOLS))
SQUASHFS3_HOST_TOOLS_TARGET_DIR:=$(addprefix $(TOOLS_DIR)/,$(SQUASHFS3_HOST_TOOLS))
...
$(SQUASHFS3_HOST_TOOLS_BUILD_DIR): $(SQUASHFS3_HOST_DIR)/.unpacked $(LZMA_DIR)/liblzma.a
	$(MAKE) CC="$(TOOLS_CC)" CXX="$(TOOLS_CXX)" LZMA_DIR="$(abspath $(LZMA_DIR))" \
		-C $(SQUASHFS3_HOST_BUILD_DIR) all
	touch -c $@

$(SQUASHFS3_HOST_TOOLS_TARGET_DIR): $(TOOLS_DIR)/%: $(SQUASHFS3_HOST_BUILD_DIR)/%
	$(INSTALL_FILE)
	strip $@
