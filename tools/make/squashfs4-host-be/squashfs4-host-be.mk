...
SQUASHFS4_HOST_BE_DIR:=$(TOOLS_SOURCE_DIR)/squashfs$(SQUASHFS4_HOST_BE_VERSION)
...
SQUASHFS4_HOST_BE_TOOLS_TARGET_DIR:=$(SQUASHFS4_HOST_BE_TOOLS:%=$(TOOLS_DIR)/%4-lzma-avm-be)
...
$(SQUASHFS4_HOST_BE_DIR)/.unpacked: $(DL_DIR)/$(SQUASHFS4_HOST_BE_SOURCE) | $(TOOLS_SOURCE_DIR) $(UNPACK_TARBALL_PREREQUISITES)
	$(call UNPACK_TARBALL,$(DL_DIR)/$(SQUASHFS4_HOST_BE_SOURCE),$(TOOLS_SOURCE_DIR))
...
$(SQUASHFS4_HOST_BE_TOOLS_TARGET_DIR): $(TOOLS_DIR)/%4-lzma-avm-be: $(SQUASHFS4_HOST_BE_BUILD_DIR)/%
	$(INSTALL_FILE)
	strip $@
