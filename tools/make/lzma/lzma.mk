...
LZMA_SOURCE_MD5_443:=c4e1b467184c7cffd4371c74df2baf0f
LZMA_SOURCE_MD5_465:=29d5ffd03a5a3e51aef6a74e9eafb759
LZMA_SOURCE_MD5:=$(LZMA_SOURCE_MD5_$(LZMA_VERSION))
LZMA_SITE:=@SF/sevenzip

LZMA_DIR:=$(TOOLS_SOURCE_DIR)/lzma$(LZMA_VERSION)
LZMA_MAKE_DIR:=$(TOOLS_DIR)/make/lzma

LZMA_IMPL_SUBDIR_443:=C
LZMA_IMPL_SUBDIR_465:=CPP
LZMA_ALONE_DIR:=$(LZMA_DIR)/$(LZMA_IMPL_SUBDIR_$(LZMA_VERSION))/7zip/Compress/LZMA_Alone
LZMA_LIB_DIR:=$(LZMA_DIR)/$(LZMA_IMPL_SUBDIR_$(LZMA_VERSION))/7zip/Compress/LZMA_Lib
...
$(LZMA_DIR)/.unpacked: $(DL_DIR)/$(LZMA_SOURCE) | $(TOOLS_SOURCE_DIR) $(UNPACK_TARBALL_PREREQUISITES)
	...
	$(call APPLY_PATCHES,$(LZMA_MAKE_DIR)/patches/$(LZMA_VERSION),$(LZMA_DIR))
	touch $@
