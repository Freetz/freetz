...
YOURFRITZ_HOST_AKC_TOOLS:=extract_avm_kernel_config gen_avm_kernel_config
YOURFRITZ_HOST_AKC_TOOLS_BUILD_DIR:=$(YOURFRITZ_HOST_AKC_TOOLS:%=$(YOURFRITZ_HOST_AKC_BUILD_DIR)/%)
YOURFRITZ_HOST_AKC_TOOLS_TARGET_DIR:=$(YOURFRITZ_HOST_AKC_TOOLS:%=$(TOOLS_DIR)/%)
...
$(YOURFRITZ_HOST_AKC_TOOLS_BUILD_DIR): $(YOURFRITZ_HOST_DIR)/.unpacked $(DTC_LIBFDT_HOST_DIR)/libfdt.a
	$(MAKE) -f Makefile.freetz -C $(YOURFRITZ_HOST_AKC_BUILD_DIR) \
		...
		$(YOURFRITZ_HOST_AKC_TOOLS)
	touch -c $@

$(YOURFRITZ_HOST_AKC_TOOLS_TARGET_DIR): $(TOOLS_DIR)/%: $(YOURFRITZ_HOST_AKC_BUILD_DIR)/%
	$(INSTALL_FILE)
