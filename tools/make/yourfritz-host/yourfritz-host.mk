YOURFRITZ_HOST_VERSION:=fba8ed34aed2169b6c1daa1e816bae1f14b49d78
YOURFRITZ_HOST_SOURCE:=yourfritz-$(YOURFRITZ_HOST_VERSION).tar.xz
YOURFRITZ_HOST_SOURCE_SHA256:=a458710e607d68294dcbe7c3534382be4c32865a00b5ab6554508717cf1e044e
...
$(YOURFRITZ_HOST_DIR)/.unpacked: $(DL_DIR)/$(YOURFRITZ_HOST_SOURCE) | $(TOOLS_SOURCE_DIR) $(UNPACK_TARBALL_PREREQUISITES)
	...
	chmod +x $(YOURFRITZ_HOST_DIR)/juis/juis_check
	touch $@
