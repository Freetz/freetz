FAKEROOT_VERSION:=1.23
FAKEROOT_SOURCE:=fakeroot_$(FAKEROOT_VERSION).orig.tar.xz
FAKEROOT_SOURCE_MD5:=b82c5e99b6365a838e73d05718083f6a
...
$(FAKEROOT_TARGET_SCRIPT): $(FAKEROOT_MAINARCH_DIR)/.configured
	...
	$(SED) -i -e 's,^PATHS=.*,PATHS=$(FAKEROOT_MAINARCH_LD_PRELOAD_PATH):$(FAKEROOT_BIARCH_LD_PRELOAD_PATH),g' $(FAKEROOT_TARGET_SCRIPT)
