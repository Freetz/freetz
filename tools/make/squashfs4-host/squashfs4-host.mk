...
# 1 - to enable
# 0 - to disable
SQUASHFS4_HOST_ENABLE_LEGACY_FORMATS_SUPPORT:=1
...
$(SQUASHFS4_HOST_TOOLS_BUILD_DIR): $(SQUASHFS4_HOST_DIR)/.unpacked $(LZMA2_HOST_DIR)/liblzma.a
	$(MAKE) -C $(SQUASHFS4_HOST_BUILD_DIR) \
		...
		LEGACY_FORMATS_SUPPORT=$(SQUASHFS4_HOST_ENABLE_LEGACY_FORMATS_SUPPORT) \
		GZIP_SUPPORT=$(SQUASHFS4_HOST_ENABLE_LEGACY_FORMATS_SUPPORT) \
		LZMA_XZ_SUPPORT=$(SQUASHFS4_HOST_ENABLE_LEGACY_FORMATS_SUPPORT) \
		XZ_SUPPORT=1 \
