...
SQUASHFS4_HOST_LE_DIR:=$(TOOLS_SOURCE_DIR)/squashfs$(SQUASHFS4_HOST_LE_VERSION)-le
...
SQUASHFS4_HOST_LE_TOOLS_TARGET_DIR:=$(SQUASHFS4_HOST_LE_TOOLS:%=$(TOOLS_DIR)/%4-lzma-le)

squashfs4-host-le-source: $(DL_DIR)/$(SQUASHFS4_HOST_LE_SOURCE)
ifneq ($(strip $(DL_DIR)/$(SQUASHFS4_HOST_LE_SOURCE)),$(strip $(DL_DIR)/$(SQUASHFS4_HOST_SOURCE)))
...
$(SQUASHFS4_HOST_LE_DIR)/.unpacked: $(DL_DIR)/$(SQUASHFS4_HOST_LE_SOURCE) | $(TOOLS_SOURCE_DIR) $(UNPACK_TARBALL_PREREQUISITES)
	...
	$(call UNPACK_TARBALL,$(DL_DIR)/$(SQUASHFS4_HOST_LE_SOURCE),$(SQUASHFS4_HOST_LE_DIR))
	mv $(SQUASHFS4_HOST_LE_DIR)/squashfs$(SQUASHFS4_HOST_LE_VERSION)/squashfs-tools $(SQUASHFS4_HOST_LE_BUILD_DIR)
	$(RM) -r $(SQUASHFS4_HOST_LE_DIR)/squashfs$(SQUASHFS4_HOST_LE_VERSION)
...
$(SQUASHFS4_HOST_LE_TOOLS_BUILD_DIR): $(SQUASHFS4_HOST_LE_DIR)/.unpacked $(LZMA2_HOST_DIR)/liblzma.a
	$(MAKE) -C $(SQUASHFS4_HOST_LE_BUILD_DIR) \
		CC="$(TOOLS_CC)" \
		EXTRA_CFLAGS="-DTARGET_FORMAT=SQUASHFS4_LE" \
...
$(SQUASHFS4_HOST_LE_TOOLS_TARGET_DIR): $(TOOLS_DIR)/%4-lzma-le: $(SQUASHFS4_HOST_LE_BUILD_DIR)/%
	$(INSTALL_FILE)
	strip $@
