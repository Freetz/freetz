...
config FREETZ_BUSYBOX__MANDATORY
	...
	select FREETZ_BUSYBOX_FEATURE_INETD_SUPPORT_BUILTIN_DAYTIME
	...
	select FREETZ_BUSYBOX_FEATURE_TFTP_BLOCKSIZE
...
config FREETZ_BUSYBOX__TUNING
	bool
#	bool "tuning"
#	select  ...

config FREETZ_BUSYBOX__OPTIONAL
	bool
#	bool "optional"
#	select  ...

config FREETZ_BUSYBOX__NET_EXPERT
	bool
#	bool "network"
#	select  ...
