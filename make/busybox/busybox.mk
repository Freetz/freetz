...
$($(PKG)_CUSTOM_CONFIG_FILE): $(TOPDIR)/.config $($(PKG)_CONFIG_FILE)
	...
	@$(call PKG_EDIT_CONFIG, \
		...
		\
		CONFIG_BASE64=$(FREETZ_BUSYBOX_BASE64) \
		\
		...
		CONFIG_FEATURE_WGET_STATUSBAR=$(FREETZ_BUSYBOX_FEATURE_WGET_STATUSBAR) \
		CONFIG_FEATURE_WGET_AUTHENTICATION=$(FREETZ_BUSYBOX_FEATURE_WGET_AUTHENTICATION) \
		CONFIG_FEATURE_WGET_TIMEOUT=$(FREETZ_BUSYBOX_FEATURE_WGET_TIMEOUT) \
		\
		...
		\
		CONFIG_LOCALE_SUPPORT=$(FREETZ_BUSYBOX_LOCALE_SUPPORT) \
		CONFIG_UNICODE_SUPPORT=$(FREETZ_BUSYBOX_UNICODE_SUPPORT) \
		CONFIG_UNICODE_USING_LOCALE=$(FREETZ_BUSYBOX_UNICODE_USING_LOCALE) \
		CONFIG_UNICODE_COMBINING_WCHARS=$(FREETZ_BUSYBOX_UNICODE_SUPPORT) \
		CONFIG_UNICODE_WIDE_WCHARS=$(FREETZ_BUSYBOX_UNICODE_SUPPORT) \
