...
$(BUSYBOX_CUSTOM_CONFIG_FILE): $(BUSYBOX_CONFIG_FILE)
	cp $(BUSYBOX_CONFIG_FILE) $(BUSYBOX_CUSTOM_CONFIG_TEMP)
	sed -i -e "s,^\(# \)\?CONFIG_INETD.*,CONFIG_INETD=$(if $(DS_PACKAGE_BUSYBOX_INETD),y,n),g" \
		$(BUSYBOX_CUSTOM_CONFIG_TEMP)
	sed -i -e "s,^\(# \)\?CONFIG_FEATURE_INETD_SUPPORT_BUILTIN_TIME.*,CONFIG_FEATURE_INETD_SUPPORT_BUILTIN_TIME=$(if $(DS_PACKAGE_BUSYBOX_INETD),y,n),g" \
		$(BUSYBOX_CUSTOM_CONFIG_TEMP)
	sed -i -e "s,^\(# \)\?CONFIG_FEATURE_INETD_SUPPORT_BUILTIN_DAYTIME.*,CONFIG_FEATURE_INETD_SUPPORT_BUILTIN_DAYTIME=$(if $(DS_PACKAGE_BUSYBOX_INETD),y,n),g" \
		$(BUSYBOX_CUSTOM_CONFIG_TEMP)
	diff -q $(BUSYBOX_CUSTOM_CONFIG_TEMP) $(BUSYBOX_CUSTOM_CONFIG_FILE) || \
		cp $(BUSYBOX_CUSTOM_CONFIG_TEMP) $(BUSYBOX_CUSTOM_CONFIG_FILE)
	rm $(BUSYBOX_CUSTOM_CONFIG_TEMP)
