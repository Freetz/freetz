...
$(PKG)_CONDITIONAL_PATCHES += no_build_timestamp
endif
...
$($(PKG)_TARGET_BINARY).links: $($(PKG)_BINARY).links
	cat $(BUSYBOX_BINARY).links | sed -r -e 's,($(if $(FREETZ_AVM_VERSION_07_0X_MIN),reboot|)blkid|wget),\1-busybox,g' > $(BUSYBOX_TARGET_BINARY).links
