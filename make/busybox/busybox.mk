$(call PKG_INIT_BIN,$(if $(FREETZ_BUSYBOX__VERSION_V127),1.27.2,$(if $(FREETZ_BUSYBOX__VERSION_V133),1.33.2,1.34.1)))
...
$(PKG)_SOURCE_MD5_1.33.2:=ce3ad663035e3d0a16580f3262e56e2e
$(PKG)_SOURCE_MD5_1.34.1:=5ad7368a73d12b8c4f8881bf7afb3d82
