...
$(BUSYBOX_CUSTOM_CONFIG_FILE): $(TOPDIR)/.config $(BUSYBOX_CONFIG_FILE)
	@cat $(BUSYBOX_CONFIG_FILE) \
		| sed -e "s,^\(# \)\?CONFIG_INETD.*,CONFIG_INETD=$(if $(DS_PACKAGE_BUSYBOX_INETD),y,n),g" \
		| sed -e "s,^\(# \)\?CONFIG_FEATURE_INETD_SUPPORT_BUILTIN_TIME.*,CONFIG_FEATURE_INETD_SUPPORT_BUILTIN_TIME=$(if $(DS_PACKAGE_BUSYBOX_INETD),y,n),g" \
		| sed -e "s,^\(# \)\?CONFIG_FEATURE_INETD_SUPPORT_BUILTIN_DAYTIME.*,CONFIG_FEATURE_INETD_SUPPORT_BUILTIN_DAYTIME=$(if $(DS_PACKAGE_BUSYBOX_INETD),y,n),g" \
		| tee $(BUSYBOX_CUSTOM_CONFIG_TEMP) \
		| diff -q - $(BUSYBOX_CUSTOM_CONFIG_FILE) || \
