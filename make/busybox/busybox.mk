...
$(BUSYBOX_CUSTOM_CONFIG_FILE): $(TOPDIR)/.config $(BUSYBOX_CONFIG_FILE)
	...
	@$(call PKG_EDIT_CONFIG, \
		...
		CONFIG_WGET=$(DS_BUSYBOX_WGET) \
		CONFIG_FEATURE_LESS=$(DS_BUSYBOX_LESS) \
		CONFIG_FEATURE_LESS_BRACKETS=$(DS_BUSYBOX_LESS) \
		CONFIG_FEATURE_LESS_REGEXP=$(DS_BUSYBOX_LESS) \
		CONFIG_FEATURE_LESS_FLAGS=$(DS_BUSYBOX_LESS) \
		CONFIG_FEATURE_NICE=$(DS_BUSYBOX_NICE) \
		CONFIG_FEATURE_LS_COLOR=$(DS_BUSYBOX_LS_COLOR) \
		CONFIG_FEATURE_LS_COLOR_IS_DEFAULT=$(DS_BUSYBOX_LS_COLOR) \
		CONFIG_NICE=$(DS_BUSYBOX_NICE) \
		CONFIG_FEATURE_EDITING_FANCY_KEY=$(DS_BUSYBOX_KEYS) \
		CONFIG_FEATURE_FAST_TOP=$(DS_BUSYBOX_FASTPROC) \
...
$(BUSYBOX_DIR)/.configured: $(BUSYBOX_DIR)/.unpacked $(BUSYBOX_CUSTOM_CONFIG_FILE) 
	...
	$(call PKG_EDIT_CONFIG, CONFIG_LFS=$(DS_TARGET_LFS)) $(BUSYBOX_DIR)/.config
	$(MAKE) CC="$(TARGET_CC)" \
