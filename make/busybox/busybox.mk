$(call PKG_INIT_BIN,$(if $(FREETZ_BUSYBOX__VERSION_V127),1.27.2,1.33.1))
#$(call PKG_INIT_BIN,$(if $(FREETZ_BUSYBOX__VERSION_V127),1.27.2,$(if $(FREETZ_BUSYBOX__VERSION_V133),1.33.1,1.34.0)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_1.27.2:=476186f4bab81781dab2369bfd42734e
$(PKG)_SOURCE_MD5_1.33.1:=7f9f8acf026ed11dfa9b672c41b204e0
#$(PKG)_SOURCE_MD5_1.34.0:=
