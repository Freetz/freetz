$(call PKG_INIT_BIN,$(if $(FREETZ_BUSYBOX__VERSION_1_31_0),1.31.0,1.27.2))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_1.27.2:=476186f4bab81781dab2369bfd42734e
$(PKG)_SOURCE_MD5_1.31.0:=cdba5d4458f944ceec5cdcf7c4914b69
$(PKG)_SOURCE_MD5:=$($(PKG)_SOURCE_MD5_$($(PKG)_VERSION))
$(PKG)_SITE:=http://www.busybox.net/downloads

$(PKG)_REBUILD_SUBOPTS += FREETZ_BUSYBOX__VERSION_1_27_2
$(PKG)_REBUILD_SUBOPTS += FREETZ_BUSYBOX__VERSION_1_31_0
$(PKG)_CONDITIONAL_PATCHES+=$($(PKG)_VERSION)

$(PKG)_REBUILD_SUBOPTS += FREETZ_KERNEL_VERSION_MAJOR
$(PKG)_CONDITIONAL_PATCHES += $($(PKG)_VERSION)/$(KERNEL_VERSION_MAJOR)

$(PKG)_REBUILD_SUBOPTS += FREETZ_BUSYBOX__BUILD_TIMESTAMP
ifneq ($(strip $(FREETZ_BUSYBOX__BUILD_TIMESTAMP)),y)
$(PKG)_CONDITIONAL_PATCHES += $($(PKG)_VERSION)/no_build_timestamp
endif
