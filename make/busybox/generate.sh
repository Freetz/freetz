...
depends_on FEATURE_PREFER_APPLETS  "FREETZ_BUSYBOX__NOEXEC_NOFORK_OPTIMIZATIONS \&\& !FREETZ_BUSYBOX__KEEP_BINARIES"
depends_on FEATURE_SH_NOFORK       "FREETZ_BUSYBOX__NOEXEC_NOFORK_OPTIMIZATIONS"
depends_on FEATURE_SH_STANDALONE   "FREETZ_BUSYBOX__NOEXEC_NOFORK_OPTIMIZATIONS \&\& !FREETZ_BUSYBOX__KEEP_BINARIES"
