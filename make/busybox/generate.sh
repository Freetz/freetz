...
echo -n " subopts ..."
echo -e "\n### Do not edit this file! Run generate.sh to create it. ###\n\n" | tee "$BBDEP.${BBVER//\./_}" > "$BBDEP"
sed -n 's/^config /$(PKG)_REBUILD_SUBOPTS += /p' "$BBOUT" | sort -u >> "$BBDEP.${BBVER//\./_}"
