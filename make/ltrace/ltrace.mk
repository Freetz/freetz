...
$(PACKAGES_DIR)/.ltrace-$($(PACKAGE_UC)_VERSION): $(DL_DIR)/$($(PACKAGE_UC)_PKG_SOURCE) | $(PACKAGES_DIR)
	@tar -C $(PACKAGES_DIR) $(VERBOSE) -xjf $(DL_DIR)/$(LTRACE_PKG_SOURCE)
	@touch $@

$($(PACKAGE_UC)_CONF): $($(PACKAGE_UC)_DIR)/.unpacked
	touch $@

$($(PACKAGE_UC)_TARGET_CONF): $($(PACKAGE_UC)_CONF)
	mkdir -p $(dir $@)
