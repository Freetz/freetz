...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div id="langmenu"><ul><li class="first"><span title="Select a language of wiki content">Language:</span></li><li class=" active"><a class="" href="strace.html" title="displaying language (default)">German</a></li><li class=" last"><a class=" notexist" href="/wiki/packages/strace.en" title="(not available)">English</a></li></ul></div><p /><div id="main">
