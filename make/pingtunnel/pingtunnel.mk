...
$(DL_DIR)/$(PINGTUNNEL_PKG_SOURCE):
	@wget -P $(DL_DIR) $(PINGTUNNEL_PKG_SITE)/$(PINGTUNNEL_PKG_SOURCE)
...
pingtunnel-package: $(PACKAGES_DIR)/.pingtunnel-$(PINGTUNNEL_VERSION)
	tar -C $(PACKAGES_DIR) $(VERBOSE) -cjf $(PACKAGES_BUILD_DIR)/$(PINGTUNNEL_PKG_SOURCE) pingtunnel-$(PINGTUNNEL_VERSION)
