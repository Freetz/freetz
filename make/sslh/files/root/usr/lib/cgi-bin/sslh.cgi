...
cgi_print_textline_p "timeout" "$SSLH_TIMEOUT" 15/255 "$(lang de:"Bei unbekanntem Protokoll dieses verwenden (zum deaktivieren leer lassen)" en:"On unknown protocol use this (leave empty to decativate)"): "
