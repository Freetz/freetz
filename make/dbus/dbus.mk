...
$(pkg)-precompiled: $($(PKG)_TARGET_BINARY) $($(PKG)_LIB_TARGET_BINARY) $($(PKG)_CONFIG_TEMPLATE_FILES_TARGET_DIR)
...
$(pkg)-uninstall:
	$(RM) $(DBUS_TARGET_BINARY) $(DBUS_TARGET_LIBDIR)/libdbus-1*.so* $(DBUS_CONFIG_TEMPLATE_FILES_TARGET_DIR)
