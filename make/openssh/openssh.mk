...
$(PKG)_CONFIG_SUBOPTS += FREETZ_PACKAGE_OPENSSH_CLIENT
$(PKG)_CONFIG_SUBOPTS += FREETZ_PACKAGE_OPENSSH_SCP
$(PKG)_CONFIG_SUBOPTS += FREETZ_PACKAGE_OPENSSH_CLIENTUTILS
$(PKG)_CONFIG_SUBOPTS += FREETZ_PACKAGE_OPENSSH_KEYUTILS
$(PKG)_CONFIG_SUBOPTS += FREETZ_PACKAGE_OPENSSH_SFTP
$(PKG)_CONFIG_SUBOPTS += FREETZ_PACKAGE_OPENSSH_SFTPCLIENT
$(PKG)_CONFIG_SUBOPTS += FREETZ_PACKAGE_OPENSSH_SSHD
...
$(OPENSSH_CLIENT_SSH_BINARY) \
	...
	$(SUBMAKE) LDFLAGS="$(OPENSSH_LDFLAGS)" LIBS="$(OPENSSH_LIBS)" -C $(OPENSSH_DIR) \
		all
