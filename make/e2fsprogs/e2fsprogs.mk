...
$(PKG)_CONFIG_SUBOPTS += FREETZ_E2FSPROGS_E2FSCK
$(PKG)_CONFIG_SUBOPTS += FREETZ_E2FSPROGS_E2MAKING
$(PKG)_CONFIG_SUBOPTS += FREETZ_E2FSPROGS_E2TUNING
$(PKG)_CONFIG_SUBOPTS += FREETZ_E2FSPROGS_E2DEBUG
$(PKG)_CONFIG_SUBOPTS += FREETZ_E2FSPROGS_E2FIXING
...
ifeq ($(strip $(FREETZ_E2FSPROGS_E2FSCK)),y)
	$(INSTALL_BINARY_STRIP)
endif

# making
$($(PKG)_MKE2FS_TARGET_BINARY): $($(PKG)_MKE2FS_BINARY)
ifeq ($(strip $(FREETZ_E2FSPROGS_E2MAKING)),y)
	$(INSTALL_BINARY_STRIP)
endif
...
ifeq ($(strip $(FREETZ_E2FSPROGS_E2TUNING)),y)
	$(INSTALL_BINARY_STRIP)
endif
...
ifeq ($(strip $(FREETZ_E2FSPROGS_E2DEBUG)),y)
	$(INSTALL_BINARY_STRIP)
endif
...
ifeq ($(strip $(FREETZ_E2FSPROGS_E2FIXING)),y)
	$(INSTALL_BINARY_STRIP)
endif
