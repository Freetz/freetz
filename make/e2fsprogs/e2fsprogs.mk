...
ifeq ($(strip $(FREETZ_PACKAGE_E2FSPROGS_MKE2FS)),y)
$(PKG)_MKE2FS_BINARY:=$($(PKG)_DIR)/misc/mke2fs
$(PKG)_MKE2FS_TARGET_BINARY:=$($(PKG)_DEST_DIR)/usr/sbin/mke2fs
endif

ifeq ($(strip $(FREETZ_PACKAGE_E2FSPROGS_TUNE2FS)),y)
...
$(PKG)_BLKID_BINARY:=$($(PKG)_DIR)/misc/blkid
...
$(PKG)_CONFIG_SUBOPTS += FREETZ_PACKAGE_E2FSPROGS_MKE2FS
$(PKG)_CONFIG_SUBOPTS += FREETZ_PACKAGE_E2FSPROGS_TUNE2FS
