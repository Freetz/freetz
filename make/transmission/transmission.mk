...
$(DL_DIR)/$(TRANSMISSION_PKG_SOURCE):
	@wget -P $(DL_DIR) $(TRANSMISSION_PKG_SITE)/$(TRANSMISSION_PKG_SOURCE)
...
transmission-package: $(PACKAGES_DIR)/.transmission-$(TRANSMISSION_VERSION)
	tar -C $(PACKAGES_DIR) $(VERBOSE) -cjf $(PACKAGES_BUILD_DIR)/$(TRANSMISSION_PKG_SOURCE) transmission-$(TRANSMISSION_VERSION)
