$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_BIP_VERSION_089),0.8.9,0.9.0-rc3))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.gz
$(PKG)_SOURCE_MD5_0.8.9:=04158ad020db221ed87cdc03660ef6c9
$(PKG)_SOURCE_MD5_0.9.0-rc3:=f4c9af03b591d475396424e212fa41e2
$(PKG)_SOURCE_MD5:=$($(PKG)_SOURCE_MD5_$($(PKG)_VERSION))
$(PKG)_SITE_0.8.9:=61
$(PKG)_SITE_0.9.0-rc3:=87
$(PKG)_SITE:=http://projects.duckcorp.org/attachments/download/$($(PKG)_SITE_$($(PKG)_VERSION))
