...
<p>
$(lang de:"Verzeichnis von external" en:"Directory for external"):
...
<label for="e1">$(lang de:"Folgende externalisierte Freetz-Dienste behandeln" en:"Manage these externalized services of Freetz")</label>: $_services
</p>
<p>
