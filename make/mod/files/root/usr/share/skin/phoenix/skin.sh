...
<div id="world">
<div id="header">
<h1><a href="https://freetz-ng.github.io/freetz-ng/" target="_blank" class="logo">Freetz</a>&nbsp;<a id="about" href="/cgi-bin/about.cgi" target="_blank">&ndash;</a>&nbsp;<span class="title">$title</span></h1>
EOF
if [ -n "$_CGI_HELP" ]; then
