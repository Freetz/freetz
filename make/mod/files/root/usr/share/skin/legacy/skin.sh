...
<div class="titlebar"><a href="http://www.freetz.org/" target="_blank" class="logo">Freetz</a>&nbsp;<a href="/cgi-bin/about.cgi" target="_blank">&ndash;</a>&nbsp;<span class="title">$title</span>$help</div>
</td>
