...
cat << EOF
<p>
<input id="e3" type="text" name="tmppath" value='$(httpd -e "$DAVFS2_TMPPATH")'>
</p>
EOF
...
"<hr color='silver'>" + 
"<p><label for='r05'>Mountpoint: </label><input id='r05' type='text' name='mountpoint1' size='50' maxlength='255' value='$(httpd -e "$DAVFS2_MOUNTPOINT1")'></p>" + 
"</div>");
...
"<hr color='silver'>" + 
"<p><label for='r15'>Mountpoint: </label><input id='r15' type='text' name='mountpoint2' size='50' maxlength='255' value='$(httpd -e "$DAVFS2_MOUNTPOINT2")'></p>" + 
"</div>");
...
"<hr color='silver'>" + 
"<p><label for='r25'>Mountpoint: </label><input id='r25' type='text' name='mountpoint3' size='50' maxlength='255' value='$(httpd -e "$DAVFS2_MOUNTPOINT3")'></p>" + 
"</div>");
</script>
