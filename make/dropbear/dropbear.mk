...
$(PKG)_CONFIG_SUBOPTS += DS_PACKAGE_DROPBEAR_SERVER_ONLY
$(PKG)_CONFIG_SUBOPTS += DS_PACKAGE_DROPBEAR_WITH_ZLIB

$(PKG)_CONFIGURE_OPTIONS += $(if $(DS_PACKAGE_DROPBEAR_WITH_ZLIB),,--disable-zlib)
