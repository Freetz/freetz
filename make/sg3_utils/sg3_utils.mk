...
$(PACKAGE_INIT_BIN)
$(PACKAGE_UC)_SOURCE:=sg3_utils-$($(PACKAGE_UC)_VERSION).tgz
$(PACKAGE_UC)_SITE:=http://sg.torque.net/sg/p/
$(PACKAGE_UC)_BINARY:=$($(PACKAGE_UC)_DIR)/sg_start
$(PACKAGE_UC)_TARGET_BINARY:=$($(PACKAGE_UC)_DEST_DIR)/usr/bin/sg_start
