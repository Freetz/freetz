$(call PKG_INIT_BIN, $(if $(FREETZ_PHP_VERSION_5_3),5.3.28,$(if $(FREETZ_PHP_VERSION_5_4),5.4.27,5.5.11)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_5.3.28:=56ff88934e068d142d6c0deefd1f396b
$(PKG)_SOURCE_MD5_5.4.27:=1c6e99187d25023411b663ea09f145ee
$(PKG)_SOURCE_MD5_5.5.11:=c8c9ad960bae0265054b5879423f7a75
