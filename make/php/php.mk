$(call PKG_INIT_BIN, $(if $(FREETZ_PHP_VERSION_5_4),5.4.45,$(if $(FREETZ_PHP_VERSION_5_6),5.6.24,5.5.38)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_5.4.45:=185f67f1ca652b18bc0cca9d7edbde7c
$(PKG)_SOURCE_MD5_5.5.38:=312244a0eecad602a1555ed2434e223f
$(PKG)_SOURCE_MD5_5.6.24:=2ab124d58b7b763ca453f6a18ec3866b
