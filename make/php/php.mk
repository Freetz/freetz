$(call PKG_INIT_BIN, $(if $(FREETZ_PHP_VERSION_5_3),5.3.27,$(if $(FREETZ_PHP_VERSION_5_4),5.4.21,5.5.5)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_5.3.27:=25ae23a5b9615fe8d33de5b63e1bb788
$(PKG)_SOURCE_MD5_5.4.21:=3dcf021e89b039409d0b1c346b936b5f
$(PKG)_SOURCE_MD5_5.5.5:=186c330c272d6322d254db9b2d18482a
