$(call PKG_INIT_BIN, $(if $(FREETZ_PHP_VERSION_5_3),5.3.27,$(if $(FREETZ_PHP_VERSION_5_4),5.4.20,5.5.4)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_5.3.27:=25ae23a5b9615fe8d33de5b63e1bb788
$(PKG)_SOURCE_MD5_5.4.20:=e25db5592ed14842b4239be9d990cce8
$(PKG)_SOURCE_MD5_5.5.4:=456f2eb1ee36f2a277bd4cc778e720eb
