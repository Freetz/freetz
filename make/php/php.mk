$(call PKG_INIT_BIN, $(if $(FREETZ_PHP_VERSION_5_3),5.3.27,$(if $(FREETZ_PHP_VERSION_5_4),5.4.22,5.5.6)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_5.3.27:=25ae23a5b9615fe8d33de5b63e1bb788
$(PKG)_SOURCE_MD5_5.4.22:=0a7400d1d7f1f55b2b36285bf1a00762
$(PKG)_SOURCE_MD5_5.5.6:=1472b1f968a2a4ae8b26f3134a116011
