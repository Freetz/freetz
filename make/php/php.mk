$(call PKG_INIT_BIN, $(if $(FREETZ_PHP_VERSION_5_3),5.3.28,$(if $(FREETZ_PHP_VERSION_5_4),5.4.23,5.5.7)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_5.3.28:=56ff88934e068d142d6c0deefd1f396b
$(PKG)_SOURCE_MD5_5.4.23:=023857598b92ea5c78137543817f4bc5
$(PKG)_SOURCE_MD5_5.5.7:=19d1ca0a58e192bcc133f700c7e78037
