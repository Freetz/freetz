$(call PKG_INIT_BIN, $(if $(FREETZ_PHP_VERSION_5_3),5.3.28,$(if $(FREETZ_PHP_VERSION_5_4),5.4.28,5.5.12)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_5.3.28:=56ff88934e068d142d6c0deefd1f396b
$(PKG)_SOURCE_MD5_5.4.28:=1676c807683041445f0df63913738571
$(PKG)_SOURCE_MD5_5.5.12:=943af92c2e67bba29429bdd9acf9cbd4
