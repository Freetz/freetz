$(call PKG_INIT_BIN, $(if $(FREETZ_PHP_VERSION_5_3),5.3.27,$(if $(FREETZ_PHP_VERSION_5_4),5.4.18,5.5.2)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_5.3.27:=25ae23a5b9615fe8d33de5b63e1bb788
$(PKG)_SOURCE_MD5_5.4.18:=b2e185b46b22a48a385cf21a0dc76e65
$(PKG)_SOURCE_MD5_5.5.2:=caf7f4d86514a568fb3c8021b096a9f0
