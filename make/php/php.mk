$(call PKG_INIT_BIN, $(if $(FREETZ_PHP_VERSION_5_3),5.3.28,$(if $(FREETZ_PHP_VERSION_5_4),5.4.30,5.5.14)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_5.3.28:=56ff88934e068d142d6c0deefd1f396b
$(PKG)_SOURCE_MD5_5.4.30:=a8a27fdc1d9e1020c9f8922b608326de
$(PKG)_SOURCE_MD5_5.5.14:=b53e5f47c59ffbe26d20957636695baa
