$(call PKG_INIT_BIN, $(if $(FREETZ_PHP_VERSION_5_3),5.3.27,$(if $(FREETZ_PHP_VERSION_5_4),5.4.19,5.5.3)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_5.3.27:=25ae23a5b9615fe8d33de5b63e1bb788
$(PKG)_SOURCE_MD5_5.4.19:=f06f99b9872b503758adab5ba7a7e755
$(PKG)_SOURCE_MD5_5.5.3:=886b08ee6865d654911a6bb02ae98ee8
