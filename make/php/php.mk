$(call PKG_INIT_BIN, $(if $(FREETZ_PHP_VERSION_5_3),5.3.29,$(if $(FREETZ_PHP_VERSION_5_4),5.4.33,5.5.17)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_5.3.29:=9469e240cbe6ac865aeaec89b253dd30
$(PKG)_SOURCE_MD5_5.4.33:=c6878bb1cdb46bfc1e1a5cd67a024737
$(PKG)_SOURCE_MD5_5.5.17:=b36c1eb5c40b872517b35d65bd840316
