$(call PKG_INIT_BIN, $(if $(FREETZ_PHP_VERSION_5_3),5.3.28,$(if $(FREETZ_PHP_VERSION_5_4),5.4.26,5.5.10)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_5.3.28:=56ff88934e068d142d6c0deefd1f396b
$(PKG)_SOURCE_MD5_5.4.26:=979e17b5492ce9c65a3c37f22c7c9655
$(PKG)_SOURCE_MD5_5.5.10:=d608230c7890b6a0cc5b92e66e866226
