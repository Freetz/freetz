$(call PKG_INIT_BIN, $(if $(FREETZ_PHP_VERSION_5_3),5.3.29,$(if $(FREETZ_PHP_VERSION_5_4),5.4.44,5.5.28)))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_MD5_5.3.29:=9469e240cbe6ac865aeaec89b253dd30
$(PKG)_SOURCE_MD5_5.4.44:=25725eb0dff0d45351b01fb483709b8d
$(PKG)_SOURCE_MD5_5.5.28:=5595dffa11f153e5b5cb8bf57242797e
