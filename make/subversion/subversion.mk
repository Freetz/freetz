$(call PKG_INIT_BIN,$(if $(FREETZ_PACKAGE_SUBVERSION_VERSION_1_9),1.9.2,$(if $(FREETZ_PACKAGE_SUBVERSION_VERSION_1_8),1.8.14,1.7.22)))
$(PKG)_MAJOR_VERSION:=1
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_SHA1_1.7.22:=6b883a0e970262f6485fc20fef68a2afcffe0875
$(PKG)_SOURCE_SHA1_1.8.14:=0698efc58373e7657f6dd3ce13cab7b002ffb497
$(PKG)_SOURCE_SHA1_1.9.2 :=fb9db3b7ddf48ae37aa8785872301b59bfcc7017
