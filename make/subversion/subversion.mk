$(call PKG_INIT_BIN,$(if $(FREETZ_PACKAGE_SUBVERSION_VERSION_1_9),1.9.4,$(if $(FREETZ_PACKAGE_SUBVERSION_VERSION_1_8),1.8.16,1.7.22)))
$(PKG)_MAJOR_VERSION:=1
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_SHA1_1.7.22:=6b883a0e970262f6485fc20fef68a2afcffe0875
$(PKG)_SOURCE_SHA1_1.8.16:=9596643a2728c55a4e54ff38608fde09b27fa494
$(PKG)_SOURCE_SHA1_1.9.4 :=bc7d51fdda43bea01e1272dfe9d23d0a9d6cd11c
