$(call PKG_INIT_BIN,$(if $(FREETZ_PACKAGE_SUBVERSION_VERSION_1_9),1.9.5,$(if $(FREETZ_PACKAGE_SUBVERSION_VERSION_1_8),1.8.17,1.7.22)))
$(PKG)_MAJOR_VERSION:=1
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_SHA1_1.7.22:=6b883a0e970262f6485fc20fef68a2afcffe0875
$(PKG)_SOURCE_SHA1_1.8.17:=0999f5e16b146f824b952a5552826b9cb5c47b13
$(PKG)_SOURCE_SHA1_1.9.5 :=8bd6a44a1aed30c4c6b6b068488dafb44eaa6adf
