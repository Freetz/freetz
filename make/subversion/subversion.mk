$(call PKG_INIT_BIN,$(if $(FREETZ_PACKAGE_SUBVERSION_VERSION_1_9),1.9.10,1.8.19))
$(PKG)_MAJOR_VERSION:=1
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.bz2
$(PKG)_SOURCE_SHA1_1.8.19:=51d7e5329ad86a650f8fc806eb68e581055a3fd1
$(PKG)_SOURCE_SHA1_1.9.10:=f38817cf51a30c940b933185739aa6f7d01a75bf
...
# Libraries
$(PKG)_LIBNAMES_SHORT := client delta diff fs fs_fs fs_util ra ra_local ra_serf ra_svn repos subr wc
