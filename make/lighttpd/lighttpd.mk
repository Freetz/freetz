...
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_LIGHTTPD_PCRE_V1
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_LIGHTTPD_PCRE_V2
...
$(PKG)_DEPENDS_ON += $(if $(FREETZ_PACKAGE_LIGHTTPD_PCRE_V1),pcre,pcre2)
...
$(PKG)_CONFIGURE_OPTIONS += $(if $(FREETZ_PACKAGE_LIGHTTPD_PCRE_V1),--with-pcre,--without-pcre)
$(PKG)_CONFIGURE_OPTIONS += $(if $(FREETZ_PACKAGE_LIGHTTPD_PCRE_V2),--with-pcre2,--without-pcre2)
