...
if [ -f /usr/lib/lighttpd/mod_evhost.so ]; then
cat << EOF
...
EOF
if [ -f /usr/lib/lighttpd/mod_redirect.so ]; then
cat << EOF
...
if [ -f /usr/lib/lighttpd/mod_auth.so ]; then
cat << EOF
...
if [ -f /usr/lib/lighttpd/mod_cgi.so ]; then
cat << EOF
...
if [ -f /usr/lib/lighttpd/mod_fastcgi.so ]; then
cat << EOF
...
if [ -f /usr/lib/lighttpd/mod_compress.so ]; then
cat << EOF
...
if [ -f /usr/lib/lighttpd/mod_status.so ]; then
cat << EOF
