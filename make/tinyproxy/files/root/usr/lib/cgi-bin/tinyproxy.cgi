...
<table>
<tr><td>Port:</td><td><input id="id_port" type="text" size="8" name="port" value="$TINYPROXY_PORT"></td>
<td>&nbsp; &nbsp;</td><td>Listen:</td><td><input id="id_listen" type="text" size="8" name="listen" value="$TINYPROXY_LISTEN"></td></tr>
<tr><td>Timeout:</td><td><input id="id_timeout" type="text" size="8" name="timeout" value="$TINYPROXY_TIMEOUT"></td>
<td>&nbsp; &nbsp;</td><td>MaxRequestsPerChild:</td><td><input id="id_maxrequestsperchild" type="text" size="8" name="maxrequestsperchild" value="$TINYPROXY_MAXREQUESTSPERCHILD"></td></tr>
<tr><td>MaxClients:</td><td><input id="id_maxclients" type="text" size="8" name="maxclients" value="$TINYPROXY_MAXCLIENTS"></td>
<td>&nbsp; &nbsp;</td><td>StartServers:</td><td><input id="id_startservers" type="text" size="8" name="startservers" value="$TINYPROXY_STARTSERVERS"></td></tr>
<tr><td>MinSpareServers:</td><td><input id="id_minspareservers" type="text" size="8" name="minspareservers" value="$TINYPROXY_MINSPARESERVERS"></td>
<td>&nbsp; &nbsp;</td><td>MaxSpareServers:</td><td><input id="id_maxspareservers" type="text" size="8" name="maxspareservers" value="$TINYPROXY_MAXSPARESERVERS"></td></tr>
<tr><td>ViaProxyName:</td><td><input id="id_viaproxyname" type="text" size="8" name="viaproxyname" value="$TINYPROXY_VIAPROXYNAME"></td>
<td>&nbsp; &nbsp;</td><td>DisableViaHeader:</td><td><input type="hidden" name="disableviaheader" value="no"><input id="id_disableviaheader" type="checkbox" name="disableviaheader" value="yes"$disableviaheader_chk></td></tr>


<tr><td>ConnectPort (*):</td><td><input id="id_connectport" type="text" size="8" name="connectport" value="$TINYPROXY_CONNECTPORT"></td>
<td>&nbsp; &nbsp;</td><td>XTinyproxy:</td><td><input type="hidden" name="xtinyproxy" value="no"><input id="id_xtinyproxy" type="checkbox" name="xtinyproxy" value="yes"$xtinyproxy_chk></td></tr>
...
<table>
<tr><td>FilterDefaultDeny:</td><td><input type="hidden" name="filterdefaultdeny" value="no"><input id="id_filterdefaultdeny" type="checkbox" name="filterdefaultdeny" value="yes"$filterdefaultdeny_chk></td>
<td>&nbsp; &nbsp;</td><td>FilterCaseSensitive:</td><td><input type="hidden" name="filtercasesensitive" value="no"><input id="id_filtercasesensitive" type="checkbox" name="filtercasesensitive" value="yes"$filtercasesensitive_chk></td></tr>
<tr><td>FilterExtended:</td><td><input type="hidden" name="filterextended" value="no"><input id="id_filterextended" type="checkbox" name="filterextended" value="yes"$filterextended_chk></td>
...
cat << EOF
<table>
<tr><td>Bind:</td><td><input id="id_bind" type="text" size="8" name="bind" value="$TINYPROXY_BIND"></td>
<td>&nbsp; &nbsp;</td><td>BindSame:</td><td><input type="hidden" name="bindsame" value="no"><input id="id_bindsame" type="checkbox" name="bindsame" value="yes"$bindsame_chk></td></tr>
EOF
...
<tr><td>AddHeader:</td><td colspan="4">
...
<tr><td>LogLevel:</td><td colspan="4">
...
<option value="Info">Info (most verbose)</option></select></td></tr>
</table>
