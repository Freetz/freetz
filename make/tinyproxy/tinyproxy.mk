...
$(PACKAGES_DIR)/.$(TINYPROXY_PKG_NAME): $(DL_DIR)/$(TINYPROXY_PKG_SOURCE)
...
tinyproxy-package: $(PACKAGES_DIR)/.$(TINYPROXY_PKG_NAME)
	tar -C $(PACKAGES_DIR) $(VERBOSE) -cjf $(PACKAGES_BUILD_DIR)/$(TINYPROXY_PKG_SOURCE) $(TINYPROXY_PKG_NAME) 

tinyproxy-precompiled: $(TINYPROXY_DIR)/$(TINYPROXY_TARGET_BINARY) tinyproxy
