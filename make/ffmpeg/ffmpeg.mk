...
$(PKG)_SOURCE_MD5:=451eb428ca97a72c00555d50944cdb24
...
$(PKG)_LIBNAMES_SHORT      := avcodec avdevice avformat avutil postproc
$(PKG)_LIBVERSIONS_MAJOR   := 52      52       52       49     51
$(PKG)_LIBVERSIONS_MINOR   := 20.1    1.0      31.0     15.0   2.0
...
$(PKG)_ENCODERS  := ac3 jpegls mpeg1video mpeg2video mpeg4 pcm_s16be pcm_s16le png vorbis zlib
$(PKG)_DECODERS  := aac ac3 atrac3 gif h264 jpegls mp2 mp3 mpeg1video mpeg2video mpeg4 mpeg4aac mpegvideo pcm_s16be pcm_s16le png vorbis wmav1 wmav2 zlib
$(PKG)_MUXERS    := ac3 ffm h264 mp3 mp4 mpeg1video mpeg2video mpegts ogg oss rtp
$(PKG)_DEMUXERS  := ac3 ffm h264 mp3 mpegps mpegts mpegvideo ogg rm rtsp sdp v4l2
$(PKG)_PARSERS   := aac ac3 h264 mpegaudio mpegvideo mpeg4video
...
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_FFMPEG_IPV6
...
$(PKG)_CONFIGURE_OPTIONS += --disable-libfaad
...
$(PKG)_CONFIGURE_OPTIONS += --disable-vhook
...
$(pkg)-clean:
	...
	$(RM) -r \
		$(FFMPEG_LIBNAMES_SHORT:%=$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/include/lib%.pc) \
...
$(pkg)-uninstall:
	$(RM) $(FFMPEG_BINARIES_ALL:%=$($(PKG)_DEST_DIR)/usr/bin/%) $(FFMPEG_LIBNAMES_SHORT:%=$(FFMPEG_TARGET_LIBDIR)/lib%*)
