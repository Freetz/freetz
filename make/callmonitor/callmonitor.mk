...
$(DL_DIR)/$(CALLMONITOR_PKG_SOURCE):
	@wget -P $(DL_DIR) $(CALLMONITOR_PKG_SITE)/$(CALLMONITOR_PKG_SOURCE)

$(PACKAGES_DIR)/.callmonitor-$(CALLMONITOR_VERSION): $(DL_DIR)/$(CALLMONITOR_PKG_SOURCE)
