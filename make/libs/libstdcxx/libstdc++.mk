...
$(PKG)_TARGET_BINARY:=$(if $(FREETZ_SEPARATE_AVM_UCLIBC),$($(PKG)_TARGET_DIR),$(TARGET_SPECIFIC_ROOT_DIR)/lib)/libstdc++.so.$($(PKG)_VERSION)
...
$(pkg)-uninstall:
	$(RM) $(TARGET_SPECIFIC_ROOT_DIR)/lib/libstdc++.so*
