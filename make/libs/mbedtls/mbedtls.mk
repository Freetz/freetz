$(call PKG_INIT_LIB, $(if $(FREETZ_AVM_GCC_4_MAX),2.7.18,2.25.0))
$(PKG)_SOURCE:=mbedtls-$($(PKG)_VERSION).tar.gz
$(PKG)_SOURCE_SHA1_ABANDON:=d3c68e3a46693d57b523ffeb1d28c136e5d7b407
$(PKG)_SOURCE_SHA1_CURRENT:=cad99b9fa62780b6fe650f6a515af5dc0f51c846
