...
$(PKG)_CFLAGS+=-DPJMEDIA_SDP_NEG_PREFER_REMOTE_CODEC_ORDER=$(if $(DS_PACKAGE_DTMFBOX_PREFER_REMOTE_CODEC_ORDER),1,0)
$(PKG)_CFLAGS+=-DPJMEDIA_SOUND_BUFFER_COUNT=$(DS_PACKAGE_DTMFBOX_SOUND_BUFFER_COUNT)
...
$(PKG)_CONFIGURE_OPTIONS += $(if $(DS_PACKAGE_DTMFBOX_WITH_G711_CODEC),,--disable-g711-codec)
$(PKG)_CONFIGURE_OPTIONS += $(if $(DS_PACKAGE_DTMFBOX_WITH_GSM_CODEC),,--disable-gsm-codec)
$(PKG)_CONFIGURE_OPTIONS += --disable-speex-codec
$(PKG)_CONFIGURE_OPTIONS += --disable-ilbc-codec
#$(PKG)_CONFIGURE_OPTIONS += $(if $(DS_PACKAGE_DTMFBOX_WITH_SPEEX_CODEC),,--disable-speex-codec)
#$(PKG)_CONFIGURE_OPTIONS += $(if $(DS_PACKAGE_DTMFBOX_WITH_ILBC_CODEC),,--disable-ilbc-codec)
