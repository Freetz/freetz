...
$(PKG)_SITE:=http://mesh.dl.sourceforge.net/sourceforge/openobex
...
$($(PKG)_STAGING_BINARY): $($(PKG)_BINARY)
	...
	$(PKG_FIX_LIBTOOL_LA) \
		$(TARGET_TOOLCHAIN_STAGING_DIR)/lib/libopenobex.la \
		$(TARGET_TOOLCHAIN_STAGING_DIR)/lib/pkgconfig/openobex.pc
