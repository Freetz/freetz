...
$(OPENSSL_TARGET_SSL_BINARY) $(OPENSSL_TARGET_CRYPTO_BINARY): \
		$(OPENSSL_STAGING_SSL_BINARY) $(OPENSSL_STAGING_CRYPTO_BINARY)
	...
	$(TARGET_STRIP) $(OPENSSL_STAGING_SSL_BINARY)
	$(TARGET_STRIP) $(OPENSSL_STAGING_CRYPTO_BINARY)
...
openssl-precompiled: uclibc openssl $(OPENSSL_TARGET_SSL_BINARY) $(OPENSSL_TARGET_CRYPTO_BINARY)
