...
$($(PKG)_TARGET_DIR)/.exclude: $(TOPDIR)/.config
	...
	[ "$(FREETZ_HAS_AVM_USB_HOST)" != "y" -o "$(FREETZ_REMOVE_SAMBA)" == "y" -o "$(FREETZ_PACKAGE_SAMBA_SMBD)" == "y" ] && echo -e "etc/default.smbd/\nbin/inetdsamba" >> $@; \
	[ "$(FREETZ_HAS_AVM_USB_HOST)" != "y" ] || ( [ "$(FREETZ_REMOVE_SAMBA)" == "y" -o "$(FREETZ_PACKAGE_SAMBA_SMBD)" == "y" ] && [ "$(FREETZ_REMOVE_FTPD)" == "y" ] ) && echo "bin/inetdctl" >> $@; \
	touch $@
