...
ifeq ($(strip $(DS_PACKAGE_IRSSI_WITH_NCURSES)),y)
...
$(PKG)_CONFIGURE_OPTIONS:=\
	...
	$(if $(DS_PACKAGE_IRSSI_WITH_TERMINFO),--with-terminfo,) \
	$(if $(DS_PACKAGE_IRSSI_WITH_NCURSES),--with-ncurses,) \
...
$(IRSSI_DS_CONFIG_FILE): $(TOPDIR)/.config
	...
	@echo "DS_PACKAGE_IRSSI_WITH_TERMINFO=$(if $(DS_PACKAGE_IRSSI_WITH_TERMINFO),y,n)" > $(IRSSI_DS_CONFIG_TEMP)
	@echo "DS_PACKAGE_IRSSI_WITH_NCURSES=$(if $(DS_PACKAGE_IRSSI_WITH_NCURSES),y,n)" > $(IRSSI_DS_CONFIG_TEMP)
