$(call PKG_INIT_BIN,$(if $(FREETZ_PACKAGE_OPENVPN_VERSION_2_2),2.2.3,2.3.7))
$(PKG)_SOURCE_MD5_2.2.3:=19265405cbcbf7c86be81418ecb02f4b
$(PKG)_SOURCE_MD5_2.3.7:=5b819f7cd0b875f55f20a947224967aa
$(PKG)_SOURCE_MD5:=$($(PKG)_SOURCE_MD5_$($(PKG)_VERSION))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.$(if $(FREETZ_PACKAGE_OPENVPN_VERSION_2_2),gz,xz)
