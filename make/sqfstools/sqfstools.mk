...
ifneq ($(strip $(DL_DIR)/$(SQFSTOOLS_SOURCE)),$(strip $(DL_DIR)/$(SQUASHFS3_SOURCE)))
$(PKG_SOURCE_DOWNLOAD)
endif
$(PKG_UNPACKED)
$(PKG_CONFIGURED_NOP)
...
$(pkg)-clean:
	-$(SUBMAKE) -C $(SQFSTOOLS_BUILD_DIR) clean

$(pkg)-uninstall:
	$(RM) $(SQFSTOOLS_BINARIES_TARGET_DIR)
