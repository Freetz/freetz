...
$(DL_DIR)/$(SPINDOWN_CGI_PKG_SOURCE):
	@wget -P $(DL_DIR) $(SPINDOWN_CGI_PKG_SITE)/$(SPINDOWN_CGI_PKG_SOURCE)

$(PACKAGES_DIR)/.spindown-cgi-$(SPINDOWN_CGI_VERSION): $(DL_DIR)/$(SPINDOWN_CGI_PKG_SOURCE)
