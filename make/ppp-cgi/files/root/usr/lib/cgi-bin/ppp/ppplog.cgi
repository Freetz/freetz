...
echo -n '<textarea style="width: '$_width'px;" name="logfile" rows="21" cols="10" wrap="off" readonly>'
...
if [ -e $PPP_FABALOG ]; then
	...
	echo -n '<textarea style="width: '$_width'px;" name="fallback" rows="21" cols="10" wrap="off" readonly>'
