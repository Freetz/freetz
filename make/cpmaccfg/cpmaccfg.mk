...
$(DL_DIR)/$(CPMACCFG_PKG_SOURCE):
	@wget -P $(DL_DIR) $(CPMACCFG_PKG_SITE)/$(CPMACCFG_PKG_SOURCE)
...
cpmaccfg-package: $(PACKAGES_DIR)/.$(CPMACCFG_PKG_NAME)
	tar -C $(PACKAGES_DIR) $(VERBOSE) -cjf $(PACKAGES_BUILD_DIR)/$(CPMACCFG_PKG_SOURCE) $(CPMACCFG_PKG_NAME)
