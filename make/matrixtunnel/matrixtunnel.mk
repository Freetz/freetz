...
MATRIXTUNNEL_TARGET_BINARY:=src/matrixtunnel
...
matrixtunnel-precompiled: uclibc matrixssl-precompiled $(MATRIXTUNNEL_DIR)/$(MATRIXTUNNEL_TARGET_BINARY) matrixtunnel
	$(TARGET_STRIP) $(MATRIXTUNNEL_DIR)/$(MATRIXTUNNEL_TARGET_BINARY)
	cp $(MATRIXTUNNEL_DIR)/$(MATRIXTUNNEL_TARGET_BINARY) $(MATRIXTUNNEL_TARGET_DIR)/
