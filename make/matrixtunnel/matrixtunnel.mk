...
#MATRIXTUNNEL_PKG_SITE:=http://www.eiband.info/dsmod
MATRIXTUNNEL_PKG_SOURCE:=matrixtunnel-$(MATRIXTUNNEL_VERSION)-dsmod-binary-only.tar.bz2
#MATRIXTUNNEL_PKG_SITE:=http://www.eiband.info/dsmod/testing
...
$(DL_DIR)/$(MATRIXTUNNEL_PKG_SOURCE):
	@wget -P $(DL_DIR) $(MATRIXTUNNEL_PKG_SITE)/$(MATRIXTUNNEL_PKG_SOURCE)
