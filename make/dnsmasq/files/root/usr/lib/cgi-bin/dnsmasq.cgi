...
cat << EOF
<br>
$(lang de:"Puffer f&uuml;r asynchrones Logging (Zeilen)" en:"Lines for ansynchronous logging"): <input type="text" name="log_async" size="5" maxlength="5" value="$(html "$DNSMASQ_LOG_ASYNC")">
<br>
