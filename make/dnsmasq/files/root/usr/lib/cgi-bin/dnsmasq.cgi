...
<input id="c1" type="checkbox" name="stop_dns_rebind" value="yes"$stop_dns_rebind_chk><label for="c1"> $(lang de:"Adressen von Upstream Nameservern ablehen, wenn sie in einem privaten IP-Bereichen sind." en:"Reject addresses from upstream nameservers which are in the private IP ranges.")</label><br>
</p>
