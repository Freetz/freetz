...
cat << EOF
<br>
$(lang de:"Puffer f&uuml;r asynchrones Logging (Zeilen)" en:"Buffer for ansynchronous logging (lines)") (min 5 / max 100): <input type="text" name="log_async" size="5" maxlength="3" value="$(html "$DNSMASQ_LOG_ASYNC")">
<br>
