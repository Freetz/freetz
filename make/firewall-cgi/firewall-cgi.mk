...
$(DL_DIR)/$(FIREWALL_CGI_PKG_SOURCE):
	@wget -P $(DL_DIR) $(FIREWALL_CGI_PKG_SITE)/$(FIREWALL_CGI_PKG_SOURCE)

$(PACKAGES_DIR)/.firewall-cgi-$(FIREWALL_CGI_VERSION): $(DL_DIR)/$(FIREWALL_CGI_PKG_SOURCE)
