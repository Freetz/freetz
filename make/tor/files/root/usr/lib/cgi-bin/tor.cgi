...
<p>
<label for="geoip_cafile">$(lang de:"CA-Datei GeoIP DB download (leer: --no-check-certificate)" en:"CA-file (empty: --no-check-certificate)"): </label>
<input type="text" id="geoip_cafile" name="geoip_cafile" size="55" maxlength="255" value="$(html "$TOR_GEOIP_CAFILE")">
</p>
