...
$(PKG)_CONFIG_SUBOPTS += DS_PACKAGE_BIRD_DEBUG
$(PKG)_CONFIG_SUBOPTS += DS_PACKAGE_BIRDC
...
$(PKG)_CONFIGURE_OPTIONS += $(if $(DS_PACKAGE_BIRDC),--enable-client,--disable-client)
$(PKG)_CONFIGURE_OPTIONS += $(if $(DS_PACKAGE_BIRD_DEBUG),--enable-debug,--disable-debug)
