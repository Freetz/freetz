...
$(PKG)_CONFIGURE_OPTIONS += $(if $(DS_WGET_WITH_SSL),--with-libssl-prefix="$(TARGET_TOOLCHAIN_STAGING_DIR)/usr",--without-ssl)

$(PKG)_CONFIG_SUBOPTS += DS_WGET_WITH_SSL
