...
$(PKG)_DIR:=$($(PKG)_SOURCE_DIR)/$(DTMFBOX_SUBDIR)
...
ifneq ($(strip $(FREETZ_PACKAGE_DTMFBOX_SVN)),y)
...
$(PKG)_CONFIGURE_PRE_CMDS += $(if $(FREETZ_PACKAGE_$(PKG)_SVN),rm -Rf $(FREETZ_BASE_DIR)/$(DTMFBOX_DIR);,)
$(PKG)_CONFIGURE_PRE_CMDS += $(if $(FREETZ_PACKAGE_$(PKG)_SVN),svn co $(DTMFBOX_SVN) ../$(DTMFBOX_SUBDIR);,)
$(PKG)_CONFIGURE_PRE_CMDS += $(if $(FREETZ_PACKAGE_$(PKG)_SVN),cd $(FREETZ_BASE_DIR)/$(DTMFBOX_DIR);,)
