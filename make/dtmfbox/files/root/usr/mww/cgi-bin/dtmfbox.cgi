...
cat << EOF 
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" bordercolor="darkgray">
	  ...
	  <tr><td width="200">Nur unbekannte Anrufer: </td><td><select id='script_acc${i}_unknown_only' name='script_acc${i}_unknown_only' value='$DTMFBOX_SCRIPT_UNKNOWN_ONLY'><option value='0'>Nein</option><option value='1' $script_unknown_only>Ja</option></select></td></tr>
...
<td>
  <input id="a10b" type="text" name="voip_nameserver" value='$DTMFBOX_VOIP_NAMESERVER' size="50"> <font size='1'>max. 4, Komma getrennt</font>
</td>
</tr>
...
<p>
<table border="0" cellpadding="3" cellspacing="0" width="100%" bordercolor="darkgray">
  <tr><td style="background-color:#dddddd"><b>CAPI (ISDN/Analog)</b></td></tr><tr><td height='5'</td></tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
...
cat << EOF
    ...
    <td><select id='adjust_priority' name='adjust_priority' value='$DTMFBOX_ADJUST_PRIORITY'><option value='0'>Auto</option><option value='1' $adjust_priority>Hoch</option></select></td>
    </tr>
	<tr>
...
EOF
      ...
      then
		...
		if [ "$status_clients" = "" ]; then status_clients="-"; fi
...
cat << EOF
	...
	<pre style="font-size:11px">$status_recordings</pre>
EOF
