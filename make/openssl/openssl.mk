$(call PKG_INIT_BIN,$(if $(FREETZ_OPENSSL_VERSION_0),0.9.8zh,$(if $(FREETZ_OPENSSL_VERSION_1),1.0.2u,$(if $(FREETZ_OPENSSL_VERSION_3),3.0.1,1.1.1n))))
...
$(PKG)_SOURCE_SHA256_3.0:=c311ad853353bce796edad01a862c50a8a587f62e7e2100ef465ab53ec9b06d1
