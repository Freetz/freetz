$(call PKG_INIT_BIN,$(if $(FREETZ_OPENSSL_VERSION_0),0.9.8zh,$(if $(FREETZ_OPENSSL_VERSION_1),1.0.2u,$(if $(FREETZ_OPENSSL_VERSION_3),3.0.0-beta2,1.1.1l))))
...
$(PKG)_SOURCE_SHA256_3.0:=e76ab22879201b12f014393ee4becec7f264d8f6955b1036839128002868df71
