$(call PKG_INIT_BIN,$(if $(FREETZ_OPENSSL_VERSION_0),0.9.8zg,1.0.1p))
$(PKG)_LIB_VERSION:=$(call qstrip,$(FREETZ_OPENSSL_SHLIB_VERSION))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.gz
$(PKG)_SOURCE_MD5_0.9.8zg := 0a912b6623ac95a8627ea2bd0e0abf1b
$(PKG)_SOURCE_MD5_1.0.1p  := 7563e92327199e0067ccd0f79f436976
