$(call PKG_INIT_BIN,$(if $(FREETZ_OPENSSL_VERSION_0),0.9.8zd,1.0.1k))
$(PKG)_LIB_VERSION:=$(call qstrip,$(FREETZ_OPENSSL_SHLIB_VERSION))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.gz
$(PKG)_SOURCE_MD5_0.9.8zd := e9b9ee12f2911e1a378e2458d9bfff77
$(PKG)_SOURCE_MD5_1.0.1k  := d4f002bd22a56881340105028842ae1f
