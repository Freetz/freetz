$(call PKG_INIT_BIN,$(if $(FREETZ_OPENSSL_VERSION_0),0.9.8zf,1.0.1m))
$(PKG)_LIB_VERSION:=$(call qstrip,$(FREETZ_OPENSSL_SHLIB_VERSION))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.gz
$(PKG)_SOURCE_MD5_0.9.8zf := c69a4a679233f7df189e1ad6659511ec
$(PKG)_SOURCE_MD5_1.0.1m  := d143d1555d842a069cb7cc34ba745a06
