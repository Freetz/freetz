$(call PKG_INIT_BIN,$(if $(FREETZ_OPENSSL_VERSION_0),0.9.8zh,$(if $(FREETZ_OPENSSL_VERSION_1_LTS),1.0.2i,1.0.1u)))
...
$(PKG)_SOURCE_SHA256_1.0.2i  := 9287487d11c9545b6efb287cdb70535d4e9b284dd10d51441d9b9963d000de6f
