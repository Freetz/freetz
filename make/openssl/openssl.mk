$(call PKG_INIT_BIN,$(if $(FREETZ_OPENSSL_VERSION_0),0.9.8ze,1.0.1l))
$(PKG)_LIB_VERSION:=$(call qstrip,$(FREETZ_OPENSSL_SHLIB_VERSION))
$(PKG)_SOURCE:=$(pkg)-$($(PKG)_VERSION).tar.gz
$(PKG)_SOURCE_MD5_0.9.8ze := edcca64ac2fbf2b03461936d5e42a262
$(PKG)_SOURCE_MD5_1.0.1l  := cdb22925fc9bc97ccbf1e007661f2aa6
