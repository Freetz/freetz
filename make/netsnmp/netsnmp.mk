...
$(DL_DIR)/$(NETSNMP_PKG_SOURCE):
	@wget -P $(DL_DIR) $(NETSNMP_PKG_SITE)/$(NETSNMP_PKG_SOURCE)
...
netsnmp-package: $(PACKAGES_DIR)/.$(NETSNMP_PKG_NAME)
	tar -C $(PACKAGES_DIR) $(VERBOSE) -cjf $(PACKAGES_BUILD_DIR)/$(NETSNMP_PKG_SOURCE) $(NETSNMP_PKG_NAME)
