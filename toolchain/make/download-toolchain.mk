...
$(KERNEL_CROSS_COMPILER): $(DL_DIR)/$(KERNEL_TOOLCHAIN_SOURCE) | $(TOOLCHAIN_BUILD_DIR) $(KERNEL_TOOLCHAIN_SYMLINK_DOT_FILE) busybox-host tar-host
...
$(TARGET_CROSS_COMPILER): $(DL_DIR)/$(TARGET_TOOLCHAIN_SOURCE) | $(TOOLCHAIN_BUILD_DIR) $(TARGET_TOOLCHAIN_SYMLINK_DOT_FILE) busybox-host tar-host
