...
KERNEL_TOOLCHAIN_MD5SUM:=33c8a85775783fd0ebda3f81f2cd8eca

ifeq ($(strip $(TARGET_TOOLCHAIN_UCLIBC_VERSION)),0.9.28)
TARGET_TOOLCHAIN_VERSION:=0.3
TARGET_TOOLCHAIN_MD5SUM:=e4cf30afbb14e920de38d9d361f7be13
else
TARGET_TOOLCHAIN_VERSION:=0.4
TARGET_TOOLCHAIN_MD5SUM:=a8d66a7b35498447476882e274440885
endif
