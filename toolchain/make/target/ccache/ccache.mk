...
$(TARGET_TOOLCHAIN_STAGING_DIR)/$(CCACHE_TARGET_BINARY): $(CCACHE_DIR)/$(CCACHE_BINARY)
	...
	if [ -f $(TARGET_TOOLCHAIN_STAGING_DIR)/bin/$(REAL_GNU_TARGET_NAME)-gcc ]; then \
		mv $(TARGET_TOOLCHAIN_STAGING_DIR)/bin/$(REAL_GNU_TARGET_NAME)-gcc \
		   $(TARGET_TOOLCHAIN_STAGING_DIR)/bin-ccache/; \
	...
	if [ -f $(TARGET_TOOLCHAIN_STAGING_DIR)/bin/$(REAL_GNU_TARGET_NAME)-c++ ]; then \
		mv $(TARGET_TOOLCHAIN_STAGING_DIR)/bin/$(REAL_GNU_TARGET_NAME)-c++ \
		   $(TARGET_TOOLCHAIN_STAGING_DIR)/bin-ccache/; \
		( cd $(TARGET_TOOLCHAIN_STAGING_DIR)/bin-ccache; \
	...
	if [ -f $(TARGET_TOOLCHAIN_STAGING_DIR)/bin/$(REAL_GNU_TARGET_NAME)-g++ ]; then \
		mv $(TARGET_TOOLCHAIN_STAGING_DIR)/bin/$(REAL_GNU_TARGET_NAME)-g++ \
		   $(TARGET_TOOLCHAIN_STAGING_DIR)/bin-ccache/; \
		( cd $(TARGET_TOOLCHAIN_STAGING_DIR)/bin-ccache; \
