...
### L
  ...
  * **[libcap (libcap.so) 2.24/2.64](libcap.md)<a id='libcap'></a>**<br>
  ...
  * **[libgpg-error: GnuPG error library (libgpg-error.so) 1.43](libgpg-error.md)<a id='libgpg-error'></a>**<br>
  ...
  * **[libxml2 (libxml2.so) 2.9.9](libxml2.md)<a id='libxml2'></a>**<br>
...
### M
  ...
  * **[mbedtls: mbed crypto (libmbedcrypto.so) 2.7.19/2.28.0](mbedtls.md)<a id='mbedtls'></a>**<br>
...
### N
  ...
  * **[neon: libneon (libneon.so) 0.32.1](neon.md)<a id='neon'></a>**<br>
