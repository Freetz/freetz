...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <head>
    ...
    <!--[if IE]><script type="text/javascript">
      if (/^#__msie303:/.test(window.location.hash))
        ...
        <link rel="alternate" href="br2684ctl.en%3Fformat=txt" type="text/x-trac-wiki" title="Reiner Text" />
  ...
  <body>
    ...
    <div id="langmenu"><ul><li class="first"><span title="Select a language of wiki content">Language:</span></li><li class=""><a class="" href="br2684ctl.html" title="">German</a></li><li class=" active last"><a class="selected" href="br2684ctl.en.html" title="selected and displaying language">English</a></li></ul></div><p /><div id="main">
      <div id="pagepath" class="noprint">
  <a class="pathentry first" title="Zeige WikiStart an" href="/wiki">Wiki:</a><a class="pathentry" href="../packages.html" title="Zeige packages an">packages</a><span class="pathentry sep">/</span><a class="pathentry" href="br2684ctl.en.html" title="Zeige packages/br2684ctl.en an">br2684ctl.en</a>
</div>
    <div id="content" class="wiki">
      <div class="wikipage searchable">

          <div id="wikipage" class="trac-content"><h2 id="br2684ctl">br2684ctl</h2>
<p>
...
<a class="ext-link" href="https://home.regit.org/technical-articles/atm-bridging/"><span class="icon">​</span>https://home.regit.org/technical-articles/atm-bridging/</a> <br />
<a class="ext-link" href="http://http://home.sch.bme.hu/~cell/br2684/USAGE.br2684"><span class="icon">​</span>http://http://home.sch.bme.hu/~cell/br2684/USAGE.br2684</a>
</p>
<p>
Source:<br />
<a class="ext-link" href="http://home.sch.bme.hu/~cell/br2684/dist/010402/brctl-010226.c"><span class="icon">​</span>http://home.sch.bme.hu/~cell/br2684/dist/010402/brctl-010226.c</a> <br />
Patch:<br />
<a class="ext-link" href="http://home.sch.bme.hu/~cell/br2684/dist/010402/br2684-against2.4.2.diff"><span class="icon">​</span>http://home.sch.bme.hu/~cell/br2684/dist/010402/br2684-against2.4.2.diff</a> <br /> <br />
</p>
<h3 id="CreatingaFreetzImagewithbr2684ctl">Creating a Freetz Image with br2684ctl</h3>
<p>
...
</pre><pre class="wiki">Package selection  ---&gt;	Testing  ---&gt;	[*] br2684ctl (binary only)
</pre><p>
...
<pre class="wiki">Advanced options  ---&gt;	BusyBox options  ---&gt;	[*] udhcpc
</pre><p>
<br />
</p>
<h3 id="Configuringbr2684ctl">Configuring br2684ctl</h3>
<p>
There is no GUI interface for br2684ctl. There is only one executable with a number of mandatory and optional parameters.
</p>
<pre class="wiki"> br2684ctl [-c n -e 0|1 -b -s buf_size [-q qos] -a [itf.]vpi.vci ]
</pre><p>
ATM PVC number, VPI and VCI. <br />
-a [itf.]vpi.vci <br />
</p>
<p>
BR2684 interface number such as nas0, nas1,&hellip;, where the number is n (e.g. nas0 is -c 0). <br />
...
-q &lt;shaping type&gt;,&lt;encapsulation type&gt;:max_pcr&le;rate&gt;,min_pcr&le;rate&gt;,max_sdu&le;frame-size&gt; <br />
...
<pre class="wiki"> br2684ctl -b -e 0 -c 0 -a 0.32
</pre><pre class="wiki"> br2684ctl -e 0 -c 0 -q ubr,aal5:max_pcr=5Mbps,min_pcr=320kbps,max_sdu=1524 -a 0.32
</pre><p>
After the interface is created you can see it with the following command: <br />
</p>
<pre class="wiki"> ifconfig -a
</pre><p>
or <br />
</p>
<pre class="wiki"> ifconfig nas0
</pre><p>
Some details can be viewed at:
</p>
<pre class="wiki">cd /proc/net/atm/
ls -la
cat &lt;file&gt;
</pre><p>
<br />
</p>
<h3 id="ObtainIPconfigurationviaDHCP">Obtain IP configuration via DHCP</h3>
<p>
...
<pre class="wiki">cd ~/freetz-x.y/addon/
...
<pre class="wiki"> ifconfig nas0 up
</pre><p>
Obtain ip configuration info via DHCP:
</p>
<pre class="wiki"> udhcpc -i nas0 -s /etc/dhcp/default.script
</pre><h3 id="DebugingtheDHCPprocess">Debuging the DHCP process</h3>
<p>
To obtain additional debug information from the udhcpc package you need to enable this, and recompile a new image.
</p>
<pre class="wiki">cd ~/freetz-x.y/source/target-mipsel_uClibc-0.9.29/ref-8mb/busybox-1.18.5
vi .config
</pre><p>
In the .config file search for CONFIG_UDHCP_DEBUG=0 and change it to:
</p>
<pre class="wiki">CONFIG_UDHCP_DEBUG=3
</pre><p>
Initiate recompile of the busybox packages during the next make:
</p>
<pre class="wiki">cd ~/freetz-1.2/
make busybox-clean
</pre><p>
...
<pre class="wiki">udhcpc -i nas0 -s /etc/dhcp/default.script -vvv
</pre><blockquote>
<p>
