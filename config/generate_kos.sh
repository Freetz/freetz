...
SYMS="
 ...
 BT_HCIBFUSB BT_HCIBTUSB ISDN_CAPI_CAPICONN CDROM_PKTCDVD DUMMY BLK_DEV_DM DM_CRYPT FW_LOADER BT_HCIUSB_SCO BLK_DEV_LOOP USB_MUSB_HDRC
  MTD_NAND BLK_DEV_NBD MTD_NAND_OHIO SCSI_MOD BLK_DEV_SD CHR_DEV_SG SLHC BLK_DEV_SR USB_PRINTER USB_STORAGE USB_IP_COMMON USB_MON
