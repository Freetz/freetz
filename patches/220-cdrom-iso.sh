...
elif [ "$FREETZ_TYPE_WLAN_3170" == "y" ]; then
	modpatch "$FILESYSTEM_MOD_DIR" "${PATCHES_DIR}/cond/rc.S-no-cdrom-fallback_3170.patch"
elif [ "$FREETZ_TYPE_FON" == "y" ] || [ "$FREETZ_TYPE_300IP_AS_FON" == "y" ] \
	|| [ "$FREETZ_TYPE_WLAN_3020" == "y" ] || [ "$FREETZ_TYPE_WLAN_3030" == "y" ] \
	|| [ "$FREETZ_TYPE_FON_WLAN" == "y" ]; then
