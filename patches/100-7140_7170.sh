[ "$FREETZ_TYPE_7140_7170" == "y" ] || return 0
...
mv "${FILESYSTEM_MOD_DIR}/etc/default.Fritz_Box_7170" "${FILESYSTEM_MOD_DIR}/etc/default.Fritz_Box_7140"

echo2 "patching rc.S and rc.conf"

sed -i -e "s/piglet_bitfile_offset=0/piglet_bitfile_offset=0x4d/g" "${FILESYSTEM_MOD_DIR}/etc/init.d/rc.S"
...
sed -i -e "s/CONFIG_INSTALL_TYPE=.*$/CONFIG_INSTALL_TYPE=\"ar7_8MB_xilinx_4eth_2ab_isdn_te_pots_wlan_usb_host_62068\"/g" "${FILESYSTEM_MOD_DIR}/etc/init.d/rc.conf"
...
modpatch "$FIRMWARE_MOD_DIR" "${PATCHES_DIR}/cond/install-7140_7170.patch" || exit 2
