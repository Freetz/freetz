...
if isFreetzType 7240 7270 7270 && isFreetzType LABOR_PHONE LABOR_CORE LABOR_IPV6 PREVIEW; then
...
elif isFreetzType 3270 3270_V3 5124 7141 7170 7240 7270 7570 || \
