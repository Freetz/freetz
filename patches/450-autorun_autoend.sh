...
if isFreetzType 7270 7270_V3 && isFreetzType LABOR_PHONE; then
	modpatch "$FILESYSTEM_MOD_DIR" "${PATCHES_DIR}/cond/450-autorun-run_mount_7270_labor_phone.patch"
	modpatch "$FILESYSTEM_MOD_DIR" "${PATCHES_DIR}/cond/450-autoend-storage_7270_labor_phone.patch"
