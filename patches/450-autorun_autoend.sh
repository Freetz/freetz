...
elif [ "$FREETZ_TYPE_FON_WLAN_7170" == "y" -a "$FREETZ_TYPE_LABOR" == "y" ]; then
	modpatch "$FILESYSTEM_MOD_DIR" "${PATCHES_DIR}/cond/450-autorun-run_mount_7170_labor_dsl.patch"
elif [ "$FREETZ_TYPE_FON_WLAN_7170" == "y" ] || [ "$FREETZ_TYPE_FON_WLAN_7240"  == "y" ] || [ "$FREETZ_TYPE_FON_WLAN_7270"  == "y"  ]; then
...
if  [ "$FREETZ_TYPE_FON_WLAN_7170" == "y" -a "$FREETZ_TYPE_LABOR" == "y" ]; then
