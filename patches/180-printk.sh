...
if isFreetzType 5010 5050 7050 7140 7141 7150 7170; then
	...
	modsed "s/takeover_printk=1/takeover_printk=0/g" $file
elif isFreetzType 3370 7340 7360 7390 || [ "$FREETZ_TYPE_FON_WLAN_7320" = "y" -a "$FREETZ_TYPE_LABOR" != "y" ]; then
	file="$FILESYSTEM_MOD_DIR/etc/init.d/S17-isdn"
	modsed "s/AVM_PRINTK/STD_PRINTK/g" $file
elif isFreetzType 3270 3270_V3 7240 7270_V2 7270_V3 7320 7330; then
