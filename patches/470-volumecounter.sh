[ "$FREETZ_TYPE_FON_WLAN_7270" == "y" ] || return 0
...
elif [ "$FREETZ_TYPE_LABOR_UMTS" == "y" ]; then
	modpatch "$FILESYSTEM_MOD_DIR" "${PATCHES_DIR}/cond/de/470-volumecounter_7270_labor_umts.patch"
else
