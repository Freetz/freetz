...
<p>$(lang de:"Pfad" en:"Path"): <input type="text" name="swap_file" size="50" maxlength="255" value="$(html "$MOD_SWAP_FILE")"> ($(lang de:"Beispiel:" en:"e.g.") /var/media/ftp/uStor01/swapfile $(lang de:"oder" en:"or") /dev/sda1)</p>
