...
EOF
	...
	echo '<p>$(lang de:"Zum Aktivieren der Swap-Datei m&uuml;&szlig;en die Einstellungen noch gespeichert werden." en:"To activate swapfile, settings must be saved.")</p>'
fi
